...
overlay.addEventListener("mousemove",function(dets){
    ...
    isscroll.style.top = `${dets.y -38}px`
})
...
document.querySelector("#page3").addEventListener("mousemove",function(dets){
    document.querySelector("#page3 #img-div").style.left = `${dets.x -0 }px`
    document.querySelector("#page3 #img-div").style.top = `${dets.y -0 }px`
})
...
document.querySelector("#page3").addEventListener("mouseenter",function(dets){
